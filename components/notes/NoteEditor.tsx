...
function ToolbarButton({
  ...
  return (
    <button
      ...
      aria-label={label}
      title={label}
      className={`inline-flex items-center justify-center h-8 min-w-8 px-1.5 rounded-md text-sm font-medium transition-colors duration-fast shrink-0
    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
      ...
      >
        ...
        <p className="text-sm text-ink-secondary mt-1.5">
          Paste a full URL. Use Remove to clear the link.
        </p>
        <input
          ref={inputRef}
          type="url"
...
function SlashMenu({
  ...
  const pos = clampMenuPosition(position.top, position.left);
