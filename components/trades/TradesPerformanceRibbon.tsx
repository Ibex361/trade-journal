...
export default function TradesPerformanceRibbon({
  ...
  return (
    <div className="bg-surface-1 backdrop-blur-md border border-surface-border rounded-panel shadow-glass p-5 flex flex-col sm:flex-row sm:items-center gap-5 motion-safe:animate-fade-rise">
